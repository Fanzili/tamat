        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="#" class="nav-link"><i class="fas fa-th"></i><span>Dashboard</span></a></li>

              <?php if($_SESSION['level']=="admin"){ ?>
                <li class="menu-header">pengelolaan data</li>
                <li><a class="nav-link" href="../data_petugas/read.php"><i class="far fa-square"></i><span>Data Petugas</span></a></li>
                ...
                <li><a class="nav-link" href="../data_spp/read.php"><i class="far fa-square"></i><span>Data Spp</span></a></li>
